...
const filtertReducer = (state = filterReducerDefaultState, action) =>{
  switch (action.type) {
...
const expenseOne = store.dispatch(addExpense({description: 'Paying Rent', amount: 5000, createdAt: -21000}));
